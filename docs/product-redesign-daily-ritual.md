...
Радикальный редизайн мобильного приложения психологической самопомощи для человека в состоянии усталости или тревоги. Вместо каталога функций создаётся единый ежедневный ритуал на 60-90 секунд: тёмный, просторный, тактильный и очень спокойный, с мягкостью Journey, Unpacking и Nintendo, но без игры и декоративной «медитативности».
...
7. **Что изменилось.** На отдельном экране человек видит собственную фразу и отмечает любое изменение, включая отсутствие изменения или ухудшение.
8. **Поддержка.** Только после собственного ответа появляется короткая поддержка и один безопасный ориентир для реальной жизни.
9. **Завершение.** «На сегодня достаточно». Нет серии, награды, предложения открыть ещё одну функцию или требования вернуться.
...
flowchart TD
    ...
    F --> G[Что изменилось?]
    G --> H[Поддержка и ориентир]
    H --> I[На сегодня достаточно]
    I --> J[До завтра]
...
3. **Сократить практики.** Собрать каждый навык вокруг одного основного ответа и отдельной рефлексии результата, сохранив безопасные границы.
...
8. **Исследовать до расширения.** Проверить понимание подбора, длительность 60-90 секунд и долю пользователей, которые называют собственное наблюдение. Только после этого решать, нужен ли раздел «Изменения» и какие данные он вправе хранить.

## Критерий успеха

После ритуала человек может назвать не только действие в интерфейсе, но и своё небольшое наблюдение: мысль стала точнее, появилось немного пространства, обозначился посильный шаг или честно ничего не изменилось.
