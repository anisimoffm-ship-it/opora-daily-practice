...
export const RITUAL_SKILLS: RitualSkill[] = [
  {
    ...
    instruction:
      "Возьми одну строгую фразу и добавь перед ней: «Я замечаю мысль, что…». Не спорь с ней и не заменяй позитивной.",
    example: "Форма ответа: «Я замечаю мысль, что…»",
    psychologistNote:
  ...
  },
  {
    ...
    example: "Форма ответа: «Я требую от себя… Сегодня достаточно…»",
    psychologistNote:
    ...
    question: {
      id: "selfPhrase",
      label: "Что сегодня было бы достаточно вместо невозможного требования к себе?",
      guidance:
        "Назови одно требование и спроси, что реалистично с твоими нынешними силами, временем и опытом. Если требование пока неясно, начни с фразы «Мне сейчас трудно, и достаточно…».",
  ...
  },
  {
    ...
    instruction:
      "Выбери безопасное начало, которое займёт не больше двух минут и не зависит от реакции другого человека.",
    example: "Форма ответа: «Первый шаг: …»",
    psychologistNote:
    ...
    question: {
      ...
      guidance:
        "Уменьшай задачу, пока не останется одно действие, которое зависит от тебя и не требует участия другого человека.",
  ...
  },
  {
    ...
    instruction:
      "Назови один проверяемый факт. Отдельно запиши то, что предполагаешь или пока не можешь узнать.",
    example: "Форма ответа: «Факт: … Пока неизвестно: …»",
    psychologistNote:
  ...
  },
  {
    ...
    example: "Форма ответа: «Произошло: … Исправить: …»",
    psychologistNote:
    ...
    question: {
      id: "eventAndRepair",
      label: "Что произошло без оценки себя, и нужно ли что-то исправить?",
      guidance:
        "Назови действие и результат, а не качество своей личности. Если последствия можно уменьшить, добавь один ближайший шаг. Если нет, так и напиши.",
      placeholder: "Произошло: ...\nИсправить: ... / Исправлять ничего не нужно",
    },
    support:
  ...
  },
  {
    ...
    example: "Форма ответа: «Помогло: … Сейчас доступно: …»",
    psychologistNote:
    ...
    question: {
      id: "supportNow",
      label: "Что помогало раньше и что из этого доступно сейчас?",
      guidance:
        "Назови конкретное действие, помощь или условие, а не успешный результат. Если ничего не доступно, напиши, какая помощь нужна.",
      placeholder: "Помогло: ...\nСейчас доступно: ... / Нужна помощь: ...",
    },
    support:
  ...
  },
  {
    ...
    example: "Форма ответа: «Мне важно… Сегодня я могу…»",
    psychologistNote:
    ...
    question: {
      id: "importantNow",
      label: "Что сейчас для тебя важно и какой маленький шаг может это поддержать?",
      guidance:
        "Назови один ориентир и одно действие, доступное сегодня. Если ориентир не находится, вспомни недавний момент, когда было хотя бы немного интересно или живо. Это может быть подсказкой, а не готовым ответом.",
  ...
  },
  {
    ...
    instruction:
      "Возьми одно недавнее действие. Отдельно назови, чего ожидал, и что произошло на самом деле.",
    example: "Форма ответа: «Я ожидал… Произошло…»",
    psychologistNote:
